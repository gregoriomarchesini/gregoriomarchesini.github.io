...
This project consists of developing a simulator using Gazebo and ROS2 for space missions involving inspection of orbiting structures using multiple deputy spacecraft.

The project will require you to build a solid software base that can be used as a test bed for planning and control algorithms dedicated to inspecting orbiting structures, such as decommissioned spacecraft, space stations, and related systems.

For more details, you can contact me by email at [gremar@kth.se](mailto:gremar@kth.se).

![Project image](/assets/img/ISS_gpt.png)
